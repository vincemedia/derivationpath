...
**In short:** This is free software that runs in your browser. It comes with no warranty. You use it entirely at your own risk, and no one behind it is responsible for any loss, including lost funds.
...
## 10. Changes, severability and entire agreement
...
## 11. No class or collective actions
...
_These Terms are also shown in the app at `#terms`. Generated from `src/terms.ts` by `npm run terms:md`; do not edit by hand._
