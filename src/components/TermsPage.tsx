...
const SECTIONS: { title: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      'The source code is licensed under the MIT License, which also provides the Software "as is" without warranty. If these Terms and the licence differ, the provision that gives the Providers greater protection from liability applies.',
    ],
  },
  {
    ...
    <main className="terms">
      ...
      <div className="card"><div className="card-body">
        ...
        <p className="terms-summary">
          <b>In short:</b> this is free software that runs in your browser. It comes with no warranty. You use it entirely at your own risk, and no one behind it is responsible for any loss, including lost funds.
        </p>
        {SECTIONS.map(s => (
